...
COPY bds.manager (manager_id, manager_firstname, manager_surname, salary, building_id) FROM stdin;
1	Miroslav	Hladký	100000	1
2	Natálie	Syrová	82000	2
3	Rudolf	Bednařík	135000	3
4	Alžběta	Stupková	35000	4
5	Marcel	Šimčík	43200	5
\.
...
SELECT pg_catalog.setval('bds.employee_employee_id_seq', 75, true);
...
REVOKE ALL ON SCHEMA bds FROM PUBLIC;
